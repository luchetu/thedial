...
export function OutboundCallDialer({
  ...
  const [callMode, setCallMode] = useState<"pstn" | "whatsapp">("pstn");
          ...
          <TabsContent value="keypad" className="absolute inset-0 flex flex-col p-0 m-0 overflow-y-auto min-h-0 data-[state=inactive]:hidden animate-in fade-in zoom-in-95 duration-300">
            ...
            <div className="px-6 pb-2 flex justify-center">
              <div className="bg-slate-100 p-1 rounded-lg flex items-center shadow-inner">
                <button
                  ...
                  className={`px-4 py-1.5 rounded-md text-xs font-semibold transition-all ${callMode === "pstn"
                ...
                <button
                  ...
                  className={`px-4 py-1.5 rounded-md text-xs font-semibold transition-all flex items-center gap-1.5 ${callMode === "whatsapp"
            ...
            <div className="flex-1 flex flex-col items-center justify-start min-h-0 pb-4 pt-2 space-y-3 z-10">
              ...
              <Button
                ...
                size="lg"
                className={`w-16 h-16 rounded-full text-white shadow-lg transition-all hover:scale-105 active:scale-95 flex items-center justify-center p-0 shrink-0 ring-4 backdrop-blur-sm ${callMode === "whatsapp"
                    ? "bg-[#25D366] hover:bg-[#20bd5a] shadow-[0_8px_24px_-4px_rgba(37,211,102,0.4)] ring-[#25D366]/30"
                    : "bg-green-500 hover:bg-green-400 shadow-[0_8px_24px_-4px_rgba(34,197,94,0.4)] ring-green-100/50"
                  }`}
              >
                {isConnecting ? (
                  ...
                  callMode === "whatsapp" ? (
                    // WhatsApp Icon (Phone with bubble feel or just simpler phone)
