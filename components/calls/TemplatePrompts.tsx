              ...
              <CardContent className="p-4 h-full">
                <div className="flex flex-col gap-3 h-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-medium text-sm line-clamp-1" title={template.title}>{template.title}</h4>
                    <p className="text-xs text-muted-foreground mt-1 line-clamp-2" title={template.description}>
